    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="mb-13">
            ...
            <div class="mb-15">
                ...
                <div class="my-1 me-5">
                    <!-- begin::Download-->
                    <a target="_blank" href="{{ asset(checkStoragePath($materi->file_materi)) }}" download
            ...
            <div class="d-flex justify-content-between">
                @php
                    ...
                    if ($materi->url_materi != null && $materi->url_materi != '') {
                        $isYoutube =
                            strpos($materi->url_materi, 'youtube.com') !== false ||
                            strpos($materi->url_materi, 'youtu.be') !== false;
                        if ($isYoutube) {
                ...
                @endphp
                @if ($isYoutube)
                    <iframe style="width: 49%;" src="{{ $url }}" title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                @elseif ($materi->url_materi != null && $materi->url_materi != '')
                    <div style="width: 49%;">
                        <a href="{{ $materi->url_materi }}" target="_blank"
                            class="btn btn-bg-light btn-active-color-primary btn-sm d-flex align-items-center justify-content-center"
                ...
                @php
                    ...
                    if ($materi->url_kedua_materi != null && $materi->url_kedua_materi != '') {
                        $isYoutube2 =
                            strpos($materi->url_kedua_materi, 'youtube.com') !== false ||
                            strpos($materi->url_kedua_materi, 'youtu.be') !== false;
                        if ($isYoutube2) {
                ...
                @endphp
                @if ($isYoutube2)
                    <iframe style="width: 49%;" src="{{ $url2 }}" title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                @elseif ($materi->url_kedua_materi != null && $materi->url_kedua_materi != '')
                    <div style="width: 49%;">
                        <a href="{{ $materi->url_kedua_materi }}" target="_blank"
                            class="btn btn-bg-light btn-active-color-primary btn-sm d-flex align-items-center justify-content-center"
                            style="width: 100%; height: 100%;">
                            <i class="bi bi-file-earmark-text me-2"></i> Lihat Materi
                        </a>
