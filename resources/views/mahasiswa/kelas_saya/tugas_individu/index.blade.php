...
@section('contentMateri')
    <div class="flex-lg-row-fluid" id="reload">
        ...
        @foreach ($materi->tugasIndividus as $index => $tugas)
            <div class="mb-1">
                ...
                <div class="mb-15">
                    ...
                    @php
                        ...
                        $sudahDitambahkan = \App\Models\PengumpulanTugasIndividu::join(
                            'tugas_individu_materis',
                            'tugas_individu_materis.id',
                            'pengumpulan_tugas_individus.tugas_individu_id',
                        )
                                ...
                                @if ($fileUploaded)
                                    ...
                                    <div class="mt-3">
                                        <form id="form-hapus-tugas"
                                            action="{{ route('mahasiswa.kelas_saya.hapusFile_tugas_individu', [$kelas->id, $materi->id, $tugas->id]) }}"
                                            method="POST">
                                            @csrf @method('DELETE')
                    ...
                    @elseif($currentTime > $deadlineTime)
                        @if ($statusUpload)
                            @if ($isComplete)
                                <div
                                    class="alert alert-dismissible bg-light-primary border-primary border-dashed d-flex flex-column p-5 mb-2">
                                    <i class="ki-duotone ki-primary fs-2hx text-primary me-4 mb-5"><span
                                        ...
                                        @if ($fileUploaded)
                                            ...
                                            <div class="mt-3">
                                                <form id="form-hapus-tugas"
                                                    ...
                                                    @csrf @method('DELETE')
                                                    <button type="button"
                                                        class="btn btn-danger btn-sm btn-flat btn-hapus-tugas">
                                                        <i class="fa fa-trash"></i> Hapus
                                                    </button>
                                                </form>
                                            </div>
                                ...
                                <form class="form" action="#" method="post">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <span class="form-text text-muted">Maksimal ukuran file adalah 1MB, harap
                                                mengupload hanya 1 file saja.</span>
                                        </div>
                                    </div>
                                </form>
                            @endif
                            ...
                            @else
                                <div
                                    ...
                                    <div class="d-flex flex-column pe-0 pe-sm-10">
                                        ...
                                        <span>Maaf, Anda sudah tidak dapat mengumpulkan tugas ini karena batas waktu
                                            pengumpulan telah berlalu atau pengumpulan tugas telah ditutup.</span>
                                    </div>
                                </div>
                            @endif
                        @endif
            ...
            <hr
                style="border: 0; height: 2px; background: linear-gradient(to right, #00c6ff, #0072ff); opacity: 0.8; border-radius: 5px; margin-top: 30px; margin-bottom: 30px;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (dropzone) {
                ...
                const routeUploadTugasIndividu =
                    `{{ route('mahasiswa.kelas_saya.upload_tugas_individu', ['kelas' => 'PLACEHOLDER_KELAS', 'materi' => 'PLACEHOLDER_MATERI', 'tugasIndividu' => 'PLACEHOLDER_TUGAS']) }}`
                ...
                var myDropzone = new Dropzone("#kt_tambah_tugas_individu_file", {
                    ...
                    previewTemplate: document.querySelector("#kt_tambah_tugas_individu_file .dropzone-item")
                ...
                myDropzone.on("addedfile", function(file) {
                    if (myDropzone.files.length > 1) {
                        ...
                        const dropzoneItems = document.querySelectorAll(
                            '#kt_tambah_tugas_individu_file .dropzone-item');
                ...
                myDropzone.on("totaluploadprogress", function(progress) {
                    const progressBars = document.querySelectorAll(
                        '#kt_tambah_tugas_individu_file .progress-bar');
                ...
                myDropzone.on("complete", function(progress) {
                    const progressBars = document.querySelectorAll(
                        '#kt_tambah_tugas_individu_file .dz-complete');
