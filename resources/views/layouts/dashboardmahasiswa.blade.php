...
<head>
    <base href="../" />
    <title>Adaptif E-Learning</title>
    <meta charset="utf-8" />
    ...
    <link href="{{ asset('assets/frontend/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <!--end::Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
    <link href="{{ asset('assets/frontend/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('assets/frontend/assets/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_app_body" data-kt-app-header-stacked="true" data-kt-app-header-primary-enabled="true"
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div id="kt_app_header" class="app-header">
                        ...
                        <div class="d-flex flex-stack align-items-stretch flex-grow-1 flex-lg-grow-0">
                            ...
                            <div class="d-flex align-items-center me-7">
                                ...
                                <a href="{{ route('mahasiswa.dashboard') }}"
                                    class="d-flex align-items-center logo-background">
                                    <img alt="Logo" src="{{ asset('assets/img/logo.png') }}"
                                        class="h-30px h-lg-55px" />
                                </a>
                                <!--end::Logo-->
                            </div>
                            <!--end::Logo wrapper-->
                            ...
                            <div class="app-navbar-item" id="kt_header_user_menu_toggle">
                                ...
                                <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 ps-3 pe-1"
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="text-white fs-8 opacity-75 fw-semibold lh-1">@yield('username')</span>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Symbol-->
                                    <div class="symbol symbol-30px symbol-md-40px">
                                        <img src="{{ asset('storage/' . (Auth::user()->foto ?? 'fotos/profil.jpg')) }}"
                                            alt="User Photo" />
                                    </div>
                                    <!--end::Symbol-->
                                </div>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="#"
                                                    class="fw-semibold text-muted text-hover-primary fs-7">@yield('userEmail')</a>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ route('mahasiswa.dashboard') }}" class="menu-link px-5">My
                                            Dashboard</a>
                                    </div>
                                    <!--end::Menu item-->
                ...
                <div class="app-header-secondary app-header-mobile-drawer" data-kt-drawer="true"
                    ...
                    data-kt-drawer-toggle="#kt_header_secondary_toggle" data-kt-sticky="true"
                    data-kt-sticky-name="app-header-secondary-sticky"
                    data-kt-sticky-offset="{default: 'false', lg: '300px'}" data-kt-swapper="true"
                    ...
                    <div class="app-container container-xxl app-container-fit-mobile d-flex align-items-stretch"
                        ...
                        <div class="header-menu d-flex align-items-stretch w-100">
                            <!--begin::Menu-->
                            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-500 menu-bullet-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch"
                                id="#kt_header_menu" data-kt-menu="true">
                                <!--begin:Menu item-->
                                <!-- Dashboard Menu Item -->
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-placement="bottom-start"
                                    class="menu-item {{ Route::is('mahasiswa.dashboard') || Route::is('mahasiswa.dashboard.*') || Route::is('mahasiswa.kelas_saya.*') ? 'show' : '' }}">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('mahasiswa.dashboard') }}" class="menu-link py-3">
                                        <span class="menu-title">
                                            <span class="menu-text">Dashboard</span>
                                            <span class="menu-desc">Profil dan Aktifitas</span>
                                        </span>
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-placement="bottom-start"
                                    class="menu-item {{ Route::is('mahasiswa.kelas') || Route::is('mahasiswa.kelas.*') ? 'show' : '' }}">
                                    <!--begin:Menu link-->
                                    <a href="{{ route('mahasiswa.kelas') }}" class="menu-link py-3">
                                        <span class="menu-title">
                                            <span class="menu-text">Kelas</span>
                                            <span class="menu-desc">Umum dan Adaptif</span>
                                        </span>
                                        <span class="menu-arrow d-lg-none"></span>
                                    </a>
                                    <!--end:Menu link-->
                ...
                <div class="app-container container-xxl d-flex flex-row flex-column-fluid">
                    ...
                    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                                    ...
                                    <div class="card-body pt-9 pb-0">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="d-flex align-items-center mb-2">
                                                            <a href="#"
                                                                class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">@yield('userName')</a>
                                                            <a href="#">
                                                    ...
                                                    <div class="d-flex my-4">
                                                        <a href="{{ route('mahasiswa.dashboard.pengaturan_profil') }}"
                                                ...
                                                <div class="d-flex flex-wrap flex-stack">
                                                        ...
                                                        <div class="d-flex flex-wrap">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="fs-2 fw-bold" data-kt-countup="false"
                                                                        data-kt-countup-value="4500"
                                                                        data-kt-countup-prefix="$">{{ $jumlahKelas }}
                                                                    </div>
                                                                </div>
                                                                <!--end::Number-->
                                                                <!--begin::Label-->
                                                                <div class="fw-semibold fs-6 text-gray-500">Jumlah
                                                                    Kelas</div>
                                                                <!--end::Label-->
                                                            </div>
                                                            <!--end::Stat-->
                                                            ...
                                                            <div
                                                                ...
                                                                <!--begin::Number-->
                                                                <div class="d-flex align-items-center">
                                                                    <div class="fs-2 fw-bold">{{ $jumlahDiskusi }}
                                                                    </div>
                                                                </div>
                                                                <!--end::Number-->
                                                                <!--begin::Label-->
                                                                <div class="fw-semibold fs-6 text-gray-500">Membuat
                                                                    Diskusi</div>
                                                                <!--end::Label-->
                                                            </div>
                                                            <!--end::Stat-->
                                                            ...
                                                            <div
                                                                ...
                                                                <!--begin::Number-->
                                                                <div class="d-flex align-items-center">
                                                                    <div class="fs-2 fw-bold">{{ $jumlahRespon }}
                                                                    </div>
                                                                </div>
                                                                <!--end::Number-->
                                                                <!--begin::Label-->
                                                                <div class="fw-semibold fs-6 text-gray-500">Komentar
                                                                    Diskusi</div>
                                                                <!--end::Label-->
                                                            </div>
                                                            <!--end::Stat-->
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                                            <span class="fw-semibold fs-6 text-gray-500">Kelengkapan
                                                                Profil</span>
                                                            <span class="fw-bold fs-6"
                                                                id="completion-percentage">{{ $completionPercentage }}%</span>
                                                        </div>
                                        ...
                                        <ul
                                            ...
                                            <li class="nav-item mt-2">
                                                ...
                                                Route::is('mahasiswa.kelas_saya.materi_pengayaan')
                                                    ? 'active'
                                                    : '' }}"
                                                    href="{{ route('mahasiswa.dashboard.kelas_saya') }}">Kelas
                                                    Saya</a>
                                            </li>
                                            ...
                                            <li class="nav-item mt-2">
                                                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('mahasiswa.dashboard.pengaturan_profil') ? 'active' : '' }}"
                                                    href="{{ route('mahasiswa.dashboard.pengaturan_profil') }}">Pengaturan
                                                    Profil</a>
                                            </li>
                                            <!--end::Nav item-->
                                            ...
                                            <!--begin::Nav item-->
                                            <li class="nav-item mt-2">
                                                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('mahasiswa.dashboard.aktivitas') ? 'active' : '' }}"
                                                    href="{{ route('mahasiswa.dashboard.aktivitas') }}">Catatan
                                                    Aktivitas</a>
                                            </li>
                                            <!--end::Nav item-->
                        ...
                        <div id="kt_app_footer" class="app-footer align-items-center justify-content-between">
                            <!--begin::Copyright-->
                            <div class="text-gray-900 order-2 order-md-1 py-4">
                                <span class="text-muted fw-semibold me-1">{{ Carbon\Carbon::now()->year }}
                                    &copy;</span>
                                <a href="{{ route('mahasiswa.dashboard') }}" target="_blank"
                                    class="text-gray-800 text-hover-primary">Adaptif E-Learning Universitas
                                    Bengkulu</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-1.jpg') }}"
                            alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-3.jpg') }}"
                            alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-8.jpg') }}"
                            alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-26.jpg') }}"
                            alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-21.jpg') }}"
                            alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-34.jpg') }}"
                            alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-27.jpg') }}"
                            alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo"
                            src="{{ asset('assets/frontend/assets/media/svg/brand-logos/google-icon.svg') }}"
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-6.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-1.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="#"
                                            class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">@yield('userName')</a>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-5.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-25.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-9.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-23.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-12.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-13.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('assets/frontend/assets/media/avatars/300-21.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
    ...
    <script src="{{ asset('assets/frontend/assets/plugins/global/plugins.bundle.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/scripts.bundle.js') }}"></script>
    <!--end::Global Javascript Bundle-->
    <!--begin::Vendors Javascript(used for this page only)-->
    <script src="{{ asset('assets/frontend/assets/plugins/custom/fslightbox/fslightbox.bundle.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('assets/frontend/assets/js/custom/pages/user-profile/general.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/widgets.bundle.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/widgets.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/apps/chat/chat.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/utilities/modals/create-app.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/utilities/modals/offer-a-deal/type.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/utilities/modals/offer-a-deal/details.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/utilities/modals/offer-a-deal/finance.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/utilities/modals/offer-a-deal/complete.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/utilities/modals/offer-a-deal/main.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/custom/utilities/modals/users-search.js') }}"></script>
    <script>
