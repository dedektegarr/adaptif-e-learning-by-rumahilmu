                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12" style="margin-bottom: 10px;">
                            <form action="{{ route('kelas.topikPembahasan.post', [$data->id]) }}" method="POST"
                                class="form">
                                @csrf @method('POST')
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('kelas') }}" class="btn btn-warning btn-sm btn-flat"><i
                                ...
                                <tbody>
                                    @foreach ($data->topikPembahasanKelas as $index => $topikPembahasan)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('kelas.topikPembahasan.subCpmk', [$data->id, $topikPembahasan->id]) }}">{{ $topikPembahasan->sub_cpmks_count }}
                                                    Data</a>
                                            </td>
                                            <td>
                                                <a
                                                    href="{{ route('kelas.topikPembahasan.materi', [$data->id, $topikPembahasan->id]) }}">{{ $topikPembahasan->materis_count }}
                                                    Data</a>
                                            </td>
                                            <td>
                                                <div class="action-buttons">
                                                    <a onclick="editTopikPembahasan({{ $data->id }}, {{ $topikPembahasan->id }})"
                                                        class="btn btn-primary btn-sm btn-flat"><i
                                                            class="fa fa-edit"></i>&nbsp; Edit</a>
                                                    <form
                                                        action="{{ route('kelas.topikPembahasan.delete', [$data->id, $topikPembahasan->id]) }}"
