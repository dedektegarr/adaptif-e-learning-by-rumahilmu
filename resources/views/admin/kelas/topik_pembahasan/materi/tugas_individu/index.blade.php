                            ...
                            <form
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('kelas.topikPembahasan.materi', [$data->topikPembahasanKelas->kelas->id, $data->topikPembahasanKelas->id]) }}"
                                        ...
                                        @foreach ($data->tugasIndividus as $index => $tugasIndividu)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($tugasIndividu->file_tugas != null)
                                                        <a class="btn btn-primary btn-sm"
                                                            href="{{ asset(checkStoragePath($tugasIndividu->file_tugas)) }}"
                                                            target="_blank">
                                                ...
                                                <td class="action-buttons">
                                                    <a href="{{ route('kelas.topikPembahasan.materi.tugasIndividu.penilaian', [$data->topikPembahasanKelas->kelas->id, $data->topikPembahasanKelas->id, $data->id, $tugasIndividu->id]) }}"
