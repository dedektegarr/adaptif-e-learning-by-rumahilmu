<div class="modal fade" id="modalEdit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form
                action="{{ route('kelas.topikPembahasan.materi.tugasIndividu.update', [$data->topikPembahasanKelas->kelas->id, $data->topikPembahasanKelas->id, $data->id]) }}"
                ...
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="tugas_individu_id" id="tugas_individu_id_edit">
                        <div class="col-md-12">
