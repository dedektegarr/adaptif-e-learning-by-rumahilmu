...
@section('subTitle', 'Soal UAS')
@section('page', 'Manajemen Soal UAS')
@section('login_as')
    Selamat Datang,
@endsection
@section('user-login2')
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-book"></i>&nbsp;Manajemen Soal Ujian Akhir Semester (UTS)</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <form action="{{ route('dosen.uas.soal.post', [$final_examId]) }}" method="POST"
                            ...
                            <table class="table table-striped table-bordered" id="soalTable" style="width:100%;">
                                ...
                                <tbody>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($final_exam_questions as $question)
                                        <tr>
                                            <td> {{ $no++ }} </td>
                                            ...
                                            <td style="display:inline-block !important;">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <form
                                                                action="{{ route('dosen.uas.soal.delete', [$final_examId, $question->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
