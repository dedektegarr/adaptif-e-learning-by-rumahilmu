        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-book"></i>&nbsp;Manajemen Sesi Ujian Akhir Semester (UAS)</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <form action="{{ route('dosen.uas.sesi.post', [$final_examId]) }}" method="POST"
                                    ...
                                    @foreach ($sesis as $sesi)
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a href="{{ route('dosen.uas.sesi.peserta', [$final_examId, $sesi->id]) }}"
                                            ...
                                            <td style="display:inline-block !important;">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <form
                                                                action="{{ route('dosen.uas.sesi.delete', [$final_examId, $sesi->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
