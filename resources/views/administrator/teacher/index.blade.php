    ...
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="col-md-12">
                    <a href="{{ route('administrator.teacher.add') }}" class="btn btn-primary btn-sm btn-flat"><i
                            class="fa fa-plus"></i>&nbsp;Tambah Data</a>
                </div>

                <div class="col-md-12">
                    <table class="table table-striped table-bordered" id="dosenTable" style="width:100%;">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>NIP</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($users as $user)
                                ...
                                @endif
                                    ...
                                    <td>
                                        <a href="{{ route('administrator.teacher.edit', [$user->id]) }}"
                                            class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp;
                                            Edit</a>
                                        <form action="{{ route('administrator.teacher.delete', [$user->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')

                                            <button type="submit"
                                                onclick="return confirm('Apa anda yakin ingin menghapus data dosen ini?')"
