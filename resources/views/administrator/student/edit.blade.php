...
@section('content')
    <section class="panel" style="margin-bottom:20px;">
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <form action="{{ route('administrator.student.update', $data->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                @method('PATCH')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jalur_masuk" class="form-control">
                                    ...
                                    <option value="snmptn" @if ($data->jalur_masuk === 'snmptn') selected @endif>snmptn</option>
                                    <option value="sbmptn" @if ($data->jalur_masuk === 'sbmptn') selected @endif>sbmptn</option>
                                    <option value="mandiri" @if ($data->jalur_masuk === 'mandiri') selected @endif>mandiri
                                    </option>
                                </select>
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" step="any" name="rata_ujian"
                                    class="tags form-control @error('rata_ujian') is-invalid @enderror"
                                    value="{{ old('rata_ujian') ?? $data->rata_ujian }}" />
                                <div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_active" class="form-control">
                                    ...
                                    <option value="1" @if ($data->is_active === 1) selected @endif>Active
                                    </option>
