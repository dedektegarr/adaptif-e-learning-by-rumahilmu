...
@section('subTitle', 'Tambah Data Admin')
@section('page', 'Tambah Data Admin')
@section('login_as')
    Selamat Datang,
@endsection
@section('user-login2')
...
@section('content')
    <section class="panel" style="margin-bottom:20px;">
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <form action="{{ route('administrator.administrator.post') }}" enctype="multipart/form-data" method="POST">
                @csrf
